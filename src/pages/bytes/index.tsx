    ...
    <div className="bytes" role="main" aria-labelledby="bytes-heading">
      <section className="bytes-hero">
        <div className="bytes-hero__container">
          <h1 id="bytes-heading" className="bytes-hero__title">Bytes</h1>
        ...
        <div className="section-container">
          ...
          >
            <div className="bytes-filters__search">
              <label htmlFor="bytes-search" className="sr-only">Search bytes</label>
              <input 
                id="bytes-search"
                type="text" 
            ...
            <div className="bytes-filters__tags" role="navigation" aria-label="Filter bytes by tag">
              <h2 id="filter-heading" className="bytes-filters__title">Filter by tag:</h2>
      ...
      <section className="bytes-topics" aria-labelledby="topics-heading">
        <div className="section-container">
          ...
          <div className="bytes-topics__grid" role="list" aria-label="Topic categories">
            ...
            >
              <div className="bytes-topics__icon bytes-topics__icon--react" aria-hidden="true"></div>
              <h3 id="topic-react" className="bytes-topics__title">Languages & Frontend</h3>
            ...
            >
              <div className="bytes-topics__icon bytes-topics__icon--typescript" aria-hidden="true"></div>
              <h3 id="topic-typescript" className="bytes-topics__title">Leadership</h3>
              <p className="bytes-topics__description">
            ...
            >
              <div className="bytes-topics__icon bytes-topics__icon--performance" aria-hidden="true"></div>
              <h3 id="topic-performance" className="bytes-topics__title">Web Performance</h3>
              <p className="bytes-topics__description">
            ...
            >
              <div className="bytes-topics__icon bytes-topics__icon--architecture" aria-hidden="true"></div>
              <h3 id="topic-architecture" className="bytes-topics__title">Architecture</h3>
              <p className="bytes-topics__description">
